...
/**
 * Represents the JavaScript callback `(isEnabled: optional) => void`.
...
class Func_void_std__optional_bool_ {
  @DoNotStrip
  @Keep
   ...
   */
  fun toLambda(): (isEnabled: Boolean?) -> Unit = this::call
   ...
   */
  @FastNative
  external fun call(isEnabled: Boolean?): Unit
}
